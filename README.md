...
```diff
-FIXME: это должно быть в paper а не тут
-  * generated quartus project https://github.com/miet-riscv-workgroup/de10-nano-bus-spider-bld-quartus
-    * This repo contain Quartus 17.1 project for Bus Spider generated by fusesoc.
-По крайней мере в references и в тексте, и в description
````
...
This repo contains source codes for Bus Spider hardware and software.
   ...
   * [длинный процесс генерации всех images from sources](#длинный-процесс-генерации-всех-images-from-sources)
...
* [InnovateFPGA 2018 | EM099 | Bus Spider (video)](https://www.youtube.com/watch?v=xk4pjrGDSXQ)
* Bus Spider
