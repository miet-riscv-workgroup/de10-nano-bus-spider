...
def parse_one(team):
    ...
    if not os.path.isfile(filename):
        os.system("wget -O %s %s 1>&2" % (filename, url))
    ...
    if not i:
        i = soup.find('div', {'class': "one-fourth"})
    if not i:
        sys.stderr.write("Warning: empty %s\n" % (team,))
        t = teaminfo(team, None, None, None, None, None, None, None, None, None)
        return t
    ...
    if j:
        ...
        sys.stderr.write("Warning: %s: no image\n" % (team,))
        img = None
    ...
    for i in infos:
        ...
        if i.title is not None:
            ...
            if not os.path.isfile(fname):
                os.system("wget -O %s %s" % (fname, i.img))

            if not os.path.isfile(sfname):
                os.system("convert %s -resize %dx%d! %s" % (fname, size, size, sfname))
...
for teams in [
    [ "EM112", "EM046", "EM080", "EM104", "EM051", "EM045", "EM057", "EM099", "EM016", "EM052", "EM075", "EM083", "EM071", "EM070", "EM077", "EM078", "EM113", "EM011", "EM039", "EM088", "EM116", "EM087", "EM055", "EM094", "EM076", "EM102", "EM043", "EM030", "EM097", "EM105", "EM084", "EM053" ],
    [ "AS033", "AS031", "AS015", "AS032", "AS005", "AS023", "AS013", "AS018", "AS043", "AS039", "AS037", "AS028", "AS027", "AS021", "AS053", "AS054", "AS055", "AS058", "AS064", "AS050", "AS017", "AS025", "AS042", "AS066", "AS002" ],
    [ "PR109", "PR022", "PR051", "PR026", "PR011", "PR061", "PR037", "PR087", "PR044", "PR066", "PR074", "PR015", "PR028", "PR095", "PR086", "PR062", "PR036", "PR138", "PR119", "PR075", "PR077", "PR081", "PR063", "PR137", "PR057", "PR076", "PR083", "PR089", "PR023", "PR129", "PR124", "PR050", "PR143", "PR144", "PR069", "PR029", "PR058", "PR148", "PR065", "PR121", "PR034", "PR082", "PR040", "PR107", "PR131", "PR060", "PR039", "PR123", "PR102", "PR072", "PR071" ],
    [ "AP074", "AP085", "AP068", "AP050", "AP062", "AP021", "AP042", "AP041", "AP071", "AP077", "AP028", "AP113", "AP027", "AP081", "AP116", "AP093", "AP121", "AP036", "AP030", "AP107", "AP034", "AP051", "AP026", "AP059", "AP112", "AP082", "AP075", "AP104", "AP089", "AP109", "AP038", "AP078", "AP095", "AP119", "AP066", "AP064" ]
    ]:
    parse_region(teams)
    print("")
